...
function processLeafRenderingInfo() {
    ...
    // circle
    this.width = RenderingUtilities.calculateBoundingCircleDiameter( this.circleForContributorsAtThisOrgLevel.width, this.circleForContributorsAtThisOrgLevel.height );
