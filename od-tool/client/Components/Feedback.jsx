FeedbackComponent = React.createClass({
	getInitialState() {
		return {
			feedback: null,
			submitted: false
				...
				<div id={this.props.modalId} className="modal">
					<div className="modal-content">
						...
						<form onSubmit={this.handleSubmit}>
							<input autofocus placeholder="Provide your feedback here." id="feedback" ref="feedback" type="text"
								   className="validate" onChange={this.handleChange}/>
						</form>
					</div>
					<div className="modal-footer">
						<a href="#!" className=" modal-action modal-close waves-effect waves-green btn" onClick={this.handleSubmit}>Submit</a>
