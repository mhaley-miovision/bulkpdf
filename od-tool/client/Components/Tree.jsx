...
var TreeView = (function() {
	...
	// group to be populated by loadData
	var svgGroup;
	...
	function getName(n) {
		return n ? n.name ? n.name : n.contributor ? n.contributor : "TBD" : "null";
	}
	...
	return {
		loadData: function(data) {
			...
			var baseSvg = d3.select(".chartContainer").append("svg")
		...
		zoomToNodeByName: function (nodeName) {
			...
			if (nodeName) {
				var n = findNodeByName(root, nodeName);
				if (n) {
					centerNode(n);
				}
			}
...
Tree = React.createClass({
	...
	renderSearch() {
		console.log(this.props.searchVisible);
