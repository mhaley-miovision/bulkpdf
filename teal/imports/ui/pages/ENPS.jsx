...
export default class ENPS extends Component {
	constructor() {
		...
		this.onEnpsReasonChanged = this.onEnpsReasonChanged.bind(this);
		this.onEnpsChanged = this.onEnpsChanged.bind(this);
		this.onSubmitForm = this.onSubmitForm.bind(this);
	}

	onEnpsReasonChanged(event) {
	...
	onSubmitForm(event) {
		...
		if (this.state.enpsRating != null && !this.state.recentlySubmitted) {
			...
			var self = this;
			setTimeout(function () {
				self.setState({recentlySubmitted: false});
			}, 3000);
								...
								<form onSubmit={this.onSubmitForm}>
									...
									<div className="row">
										<div className="col s4">
											<label>
												<input className="validate required" type="radio" name="enps_value"
													   value="1"
													   onChange={this.onEnpsChanged}/>
												<img className={this.setIconClass("1")}
													 src="/img/enps-icons/happy.jpg"/>
											</label>
										</div>
										<div className="col s4">
											<label>
												<input className="validate required" type="radio" name="enps_value"
													   value="0"
													   onChange={this.onEnpsChanged}/>
												<img className={this.setIconClass("0")}
													 src="/img/enps-icons/neutral.jpg"/>
											</label>
										</div>
										<div className="col s4">
											<label>
									...
									<div className="row">
										<div className="col s12 center">
											<input placeholder="(Optional) I feel this way because..." id="enps_reason"
												   ref="enpsReason" type="text"
									...
									<div className="row centeredItem">
										<div className="modal-footer">
											<a href="#"
											   className=" modal-action modal-close waves-effect waves-green btn background-main3"
